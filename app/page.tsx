    ...
    <main className="min-h-screen bg-gradient-to-b from-[#eaf6ff] to-[#f8fcff] text-[#123c70]">
      ...
      <header className="border-b border-[#d7eaf8] bg-white/90 backdrop-blur-xl">
        <div className="mx-auto flex max-w-6xl items-center justify-between gap-3 px-4 py-4 sm:px-8">
          <a href="/" className="shrink-0 text-[25px] font-extrabold tracking-tight text-[#0d3f79] sm:text-[29px]">Shine<span className="text-[#1683f8]">Go</span><span className="ml-1 text-[#1683f8]">✦</span></a>
          ...
          <a href="/professional/login" className="min-w-0 rounded-xl border border-[#cfe3f4] bg-white px-3 py-2.5 text-center text-xs font-bold leading-5 text-[#315f88] sm:px-4 sm:text-sm">Inloggen</a>
        </div>
      </header>
