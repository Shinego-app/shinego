      ...
      <div className="mx-auto max-w-5xl px-5 py-5 sm:px-8 sm:py-7">
        ...
        <section className="mt-5 rounded-[28px] border border-[#d5e9f8] bg-white/90 px-5 py-7 shadow-[0_18px_55px_rgba(40,93,140,.12)] sm:px-8 sm:py-9">
          <div className="mx-auto max-w-3xl">
            <h1 className="text-[32px] font-extrabold leading-tight tracking-[-.035em] text-[#0b3d75] sm:text-[38px]">Hoe de boekingsprijs wordt opgebouwd</h1>
            <p className="mt-1 text-sm font-medium text-[#537797] sm:text-base">Vooraf duidelijk wat de opdracht kost.</p>
